...
class Server extends _eventemitter["default"] {
  /**
  ...
  constructor(options) {
    ...
    this.wss = new _ws.Server(options);
    this.wss.on("listening", function () {
      return _this.emit("listening");
    });
    this.wss.on("connection", function (socket, request) {
  ...
  _runMethod(message, socket_id) {
    var _arguments = arguments,
        _this6 = this;

    return function _callee2() {
      var ns, results, event_names, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, name, index, namespace, socket_index, _results, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _name, _index, response;

      return _regenerator["default"].async(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ns = _arguments.length > 2 && _arguments[2] !== undefined ? _arguments[2] : "/";
            ...
            case 14:
              results = {};
              event_names = Object.keys(_this6.namespaces[ns].events);
            ...
            case 21:
              ...
              namespace = _this6.namespaces[ns];
            ...
            case 63:
              ...
              if (_this6.namespaces[ns].events[_name]) {
                _context2.next = 68;
                break;
              }
            ...
            case 68:
              _index = _this6.namespaces[ns].events[_name].indexOf(socket_id);
            ...
            case 72:
              _this6.namespaces[ns].events[_name].splice(_index, 1);
            ...
            case 97:
              if (_this6.namespaces[ns].rpc_methods[message.method]) {
                _context2.next = 99;
                break;
              }
            ...
            case 99:
              ...
              if (!(_this6.namespaces[ns].rpc_methods[message.method]["protected"] === true && _this6.authenticated === false)) {
                _context2.next = 102;
                break;
              }
            ...
            case 102:
              _context2.prev = 102;
              _context2.next = 105;
              return _regenerator["default"].awrap(_this6.namespaces[ns].rpc_methods[message.method].fn(message.params));
            ...
            case 117:
              ...
              if (message.method === "rpc.login" && response === true) _this6.authenticated = true;
              return _context2.abrupt("return", {
                jsonrpc: "2.0",
                result: response,
                id: message.id
      ...
      }, null, null, [[19, 39, 43, 51], [44,, 46, 50], [61, 79, 83, 91], [84,, 86, 90], [102, 108]]);
    }();
  }
  /**
  ...
  _generateNamespace(name) {
    ...
    this.namespaces[name] = {
      rpc_methods: {
        "__listMethods": {
          fn: function fn() {
            return Object.keys(_this7.namespaces[name].rpc_methods);
          },
          "protected": false
        }
      },
