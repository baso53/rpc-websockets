...
export default class Server extends EventEmitter {
        ...
        socket.on("message", (data) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (Array.isArray(parsedData)) {
                ...
                for (const message of parsedData) {
                    const response = yield this._runMethod(message, socket._id, ns);
                    if (!response)
                        continue;
            ...
            const response = yield this._runMethod(parsedData, socket._id, ns);
            if (!response)
                return;
     ...
     */
    _runMethod(message, socket_id, ns = "/") {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                response = yield this.namespaces[ns].rpc_methods[message.method].fn(message.params);
            }
            catch (error) {
                if (!message.id)
                    return;
